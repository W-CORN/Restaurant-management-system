                ...
                <div class="panel-body">
                    ...
                    <div  class="pills-struct mt-40">
                        <ul role="tablist" class="nav nav-pills" id="myTabs_6">
                            <li class="active" role="presentation"><a aria-expanded="true"  data-toggle="tab" role="tab" id="home_tab_6" href="#home_6">合同订单生产计划</a></li>
                            <li role="presentation" class=""><a  data-toggle="tab" id="profile_tab_6" role="tab" href="#profile_6" aria-expanded="false">临时订单生产计划</a></li>
                            <li class="col-lg-7">
                                <div><div class="input-group col-lg-5">
                                    <input type="date" name="example-input1-group2" class="form-control" placeholder="Search">
                                    <span class="input-group-btn">
										<button type="button" class="btn  btn-default"  data-target="#search_form" data-toggle="collapse" aria-label="Close" aria-expanded="true"><i class="zmdi zmdi-search"></i></button>
										</span>
                                </div></div>
                                                ...
                                                <div class="panel-body">
                                                    <div class="table-wrap">
                                                        <div class="table-responsive">
                                                            <table id="example0" class="table table-hover display  pb-30" >
                                                                <thead>
                                                                <tr>
                                                                    <th>合同订单号</th>
                                                                    <th>生产批次</th>
                                                                ...
                                                                <tr >
                                                                    ...
                                                                    <td>2017/12/26</td>
                                                                    <td>
                                                                        <button class="btn btn-warning btn-anim"><i class="fa fa-pencil"></i><span class="btn-text">分配任务</span></button>
                                                                        <button class="btn btn-primary btn-anim" style="display: none"><i class="fa fa-sign-out"></i><span class="btn-text">分配详情</span></button>
                                                                    </td>
                                                                </tr>
