    ...
    <div class="page-wrapper">
        <div class="container-fluid">
                            ...
                            <div class="panel-body">
                                ...
                                <div  class="pills-struct mt-40">
                                    <ul role="tablist" class="nav nav-pills" id="myTabs_6">
                                        <li class="active" role="presentation"><a aria-expanded="true"  data-toggle="tab" role="tab" id="home_tab_6" href="#home_6">合同订单任务分配查看</a></li>
                                        <li role="presentation" class=""><a  data-toggle="tab" id="profile_tab_6" role="tab" href="#profile_6" aria-expanded="false">临时订单任务分配查看</a></li>
                                        <li class="col-lg-7">
                                            <div><div class="input-group col-lg-5">
                                                <input type="text" name="example-input1-group2" class="form-control" placeholder="Search">
                                                <span class="input-group-btn">
										<button type="button" class="btn  btn-default"  data-target="#search_form" data-toggle="collapse" aria-label="Close" aria-expanded="true"><i class="zmdi zmdi-search"></i></button>
										</span>
                                                                ...
                                                                <div class="table-wrap">
                                                                    <div class="table-responsive">
                                                                        <table id="example1" class="table table-hover display  pb-30" >
                                                                            ...
                                                                            <tbody>
                                                                            <c:forEach items="${requestScope.pg1.list}" var="p">
                                                                                <tr >
                                                                                    <td>123412341</td>
                                                                                    <td>红烧肉</td>
                                                                                    <td>初加工</td>
                                                                                    <td>30</td>
                                                                                    <td>2017-12-26</td>
                                                                                    <td><a data-toggle="modal" data-target=".a"><span class="glyphicon glyphicon-th-large" aria-hidden="true"></span>详情</a></td>
                                                                                    <td>第一生产线</td>
                                                                                </tr>
                                                                            </c:forEach>
                                                                            </tbody>
                                                    ...
                                                    <div class="panel panel-default card-view">
                                                        <div class="panel-wrapper collapse in">
                                                            <div class="panel-body">
                                                                <div class="table-wrap">
                                                                    <div class="table-responsive">
                                                                        <table id="example2" class="table table-hover display  pb-30" >
                                                                            <thead>
                                                                            <tr>
                                                                                <th>临时订单编号</th>
                                                                                <th>菜品名称</th>
                                                                            ...
                                                                            <tr >
                                                                                ...
                                                                                <td>初加工</td>
                                                                                <td>30</td>
                                                                                <td><a data-toggle="modal" data-target=".bs-example-modal-lg"><span class="glyphicon glyphicon-th-large" aria-hidden="true"></span>详情</a></td>
                                                                                <td>第二生产线</td>
                                                                            </tr>
                                                                            </tbody>
                                                                        </table>
            ...
            <div class="row">
                <!--提示框-->
                <div class="col-md-6">
                    <div class="modal fade a" tabindex="-1" role="dialog" aria-labelledby="myLargeModalLabel" aria-hidden="true" style="display: none;">
                        <div class="modal-dialog modal-lg">
                            <div class="modal-content">
                                <div class="modal-header">
                                    <button type="button" class="close" data-dismiss="modal" aria-hidden="true">×</button>
                                    <h5 class="modal-title" id="myLargeModalLabe2">Large modal</h5>
                                </div>
                                <div class="modal-body">
                                    <h5 class="mb-15">合同订单详情显示</h5>
                                    <div class="panel panel-default card-view">
                                        <div class="panel-wrapper collapse in">
                                            <div class="panel-body row pa-0">
                                                <table class="table table-hover mb-0">
                                                    ...
                                                    <tr>
                                                        ...
                                                        <th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">张振国</font></font></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr>
                                                        <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">预计生产开始时间</font></font></td>
                                                        <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">2017/12/26 12:20</font></font></td>
                                                    </tr>
                                                    <tr>
                                                        <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">预计生产结束时间</font></font></td>
                                                        <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">2017/12/26 13:20</font></font></td>
                                                    </tr>
                                                    <tr>
                                                        <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">进入下一个工序的数量</font></font></td>
                                                        <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">30</font></font></td>
                                                    </tr>
                                                    <tr>
                                                        <td><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">备注</font></font></td>
                                        ...
                                        <div class="panel-wrapper collapse in">
                                            <div class="panel-body row pa-0">
                                                <table class="table table-hover mb-0">
                                                    ...
                                                    <tr>
                                                        <th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">工序负责人</font></font></th>
                                                        <th><font style="vertical-align: inherit;"><font style="vertical-align: inherit;">孙天奇</font></font></th>
                                                    </tr>
                                                    </thead>
                                                    <tbody>
                                                    <tr>
