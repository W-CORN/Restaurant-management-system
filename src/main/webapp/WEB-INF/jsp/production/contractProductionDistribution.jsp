                ...
                <div class="panel-body">
                    <div  class="pills-struct mt-40">
                        <ul role="tablist" class="nav nav-pills" id="myTabs_6">
                            <li class="active" role="presentation"><a aria-expanded="true"  data-toggle="tab" role="tab" id="home_tab_6" href="#home_6">初加工计划分配</a></li>
                            <li role="presentation" class=""><a  data-toggle="tab" id="profile_tab_6" role="tab" href="#profile_6" aria-expanded="false">精加工任务分配</a></li>
                            <li role="presentation" class=""><a  data-toggle="tab" id="profile_tab_7" role="tab" href="#profile_7" aria-expanded="false">烹饪任务分配</a></li>
                            <li role="presentation" class=""><a  data-toggle="tab" id="profile_tab_9" role="tab" href="#profile_9" aria-expanded="false">冷却任务分配</a></li>
                            <li role="presentation" class=""><a  data-toggle="tab" id="profile_tab_8" role="tab" href="#profile_8" aria-expanded="false">包装任务分配</a></li>
                            <li class="col-lg-5">
                                                        ...
                                                        <div class="col-md-12">
                                                            <div class="form-wrap">
                                                                <form action="#" class="form-horizontal">
                                                                    <div class="form-body">
                                                                        <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account-box mr-10"></i>生产订单任务分配（初加工）</h6>
                                                                        <hr class="light-grey-hr">
                                                                        <!-- /Row -->
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-md-3">工序负责人</label>
                                                                                    <div class="col-md-9">
                                                                                        <select class="form-control">
                                                                                            <option>张振国</option>
                                                                                            <option>孙天奇</option>
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-md-3">分配所属生产线</label>
                                                                                    <div class="col-md-9">
                                                                                        <select class="form-control">
                                                                                            <option>第一生产线</option>
                                                                                            <option>第二生产线</option>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-md-3">配置人数</label>
                                                                                    <div class="col-md-9">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-md-3">传至下一工序数量</label>
                                                                                    <div class="col-md-9">
                                                                                        <input type="number" class="form-control">
                                                                                    </div>
                                                                                </div>
                                                                        ...
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-md-3">预计开始时间</label>
                                                                                    <div class="col-md-9">
                                                                            ...
                                                                            <div class="col-lg-6">
                                                                                <div class="form-group">
                                                                                    <label class="control-label col-md-3">预计结束时间</label>
                                                                                    <div class="col-md-9">
                                                                            ...
                                                                            <div class="col-md-6">
                                                                                <div class="row">
                                                                                    <div class="col-md-offset-3 col-md-9">
                                                                                        <button type="submit" class="btn btn-success  mr-10">提交</button>
                                                                                    </div>
                                                                                </div>
                                                                            </div>
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-wrap">
                                                                <form action="#" class="form-horizontal">
                                                                    <div class="form-body">
                                                                        <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account-box mr-10"></i>生产订单任务分配（精加工）</h6>
                                                                        <hr class="light-grey-hr">
                                                                        <!-- /Row -->
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-wrap">
                                                                <form action="#" class="form-horizontal">
                                                                    <div class="form-body">
                                                                        <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account-box mr-10"></i>生产订单任务分配（烹饪任务）</h6>
                                                                        <hr class="light-grey-hr">
                                                                        <!-- /Row -->
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-wrap">
                                                                <form action="#" class="form-horizontal">
                                                                    <div class="form-body">
                                                                        <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account-box mr-10"></i>生产订单任务分配（冷却加工）</h6>
                                                                        <hr class="light-grey-hr">
                                                                        <!-- /Row -->
                                                                        <div class="row">
                                                                            <div class="col-md-6">
                                                    ...
                                                    <div class="row">
                                                        <div class="col-md-12">
                                                            <div class="form-wrap">
                                                                <form action="#" class="form-horizontal">
                                                                    <div class="form-body">
                                                                        <h6 class="txt-dark capitalize-font"><i class="zmdi zmdi-account-box mr-10"></i>生产订单任务分配（包装加工）</h6>
                                                                        <hr class="light-grey-hr">
                                                                        <!-- /Row -->
                                                                        <div class="row">
                                                                            <div class="col-md-6">
